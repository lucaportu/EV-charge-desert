...
COLONNINE_CSV = trova("pun_colonnine_pulito.csv")
OUTPUT_PARQUET = OUTPUT_DIR / "offerta_colonnine_per_sezione.parquet"
OUTPUT_CSV = OUTPUT_DIR / "offerta_colonnine_per_sezione.csv"
